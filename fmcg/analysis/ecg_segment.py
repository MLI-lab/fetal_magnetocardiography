...
# taken and modified from https://neuropsychology.github.io/NeuroKit/_modules/neurokit2/ecg/ecg_segment.html#ecg_segment
...
def ecg_segment(
    ...
    **kwargs
    ...
    if show is not False:
        ax = ecg_segment_plot(heartbeats, heartrate=average_hr, ytitle="ECG", **kwargs)
    if show == "return":
        return ax
...
def _ecg_segment_window(
    ...
    # Window
    epochs_start = ratio_pre * window_size * interval
    epochs_end = (1 - ratio_pre) * window_size * interval

    return -epochs_start, epochs_end, heart_rate


def ecg_segment_plot(heartbeats, heartrate=0, ytitle="ECG", color="#F44336", ax=None):
